...
DOYAKEN_COMMANDS="run chat init register unregister list status manifest doctor health skills skill config upgrade mcp hooks sync commands sessions validate stats audit generate version help"
