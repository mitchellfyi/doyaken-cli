...
DOYAKEN_COMMANDS="run chat init register unregister list tasks task add status manifest doctor skills skill config upgrade review mcp hooks sync commands sessions version help"
